...
## Ejemplos analizados (análisis rápido)

- https://nippori.lamm.tokyo/
  - Patrones transferibles:
    - Priorizar imágenes grandes y hero por proyecto para impacto inmediato.
    - Diseño de tarjetas limpias con CTA evidente para reducir la fricción.
    - Transiciones sutiles (hover/focus) para guiar atención sin distraer.

- https://pictoric.com.ua/projects
  - Patrones transferibles:
    - Miniaturas consistentes y optimizadas para mejorar lectura visual y rendimiento.
    - Uso de filtros/categorías simples para descubrimiento rápido.
    - Overlays ligeros en hover que muestran título y tags sin cubrir la obra.

- https://chloeschumacher.com/
  - Patrones transferibles:
    - Páginas de proyecto dedicadas con contexto (rol, año, breve descripción).
    - Márgenes generosos para dar respiración a las obras y mejorar escala.
    - Carga progresiva de imágenes y placeholders para una mejor percepción de velocidad.
